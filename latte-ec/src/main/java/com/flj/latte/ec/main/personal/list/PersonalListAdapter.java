...
public class PersonalListAdapter extends BaseMultiItemQuickAdapter<ListBean, BaseViewHolder> {
    ...
    public PersonalListAdapter(List<ListBean> data) {
        super(data);
        addItemType(ListItemType.ITEM_NORMAL, R.layout.arrow_item_personal_layout);
