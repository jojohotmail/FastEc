package com.flj.latte.util.up_apk.sample.v2;
...
public class V2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cv_activity_v2);
        initView();
    ...
    private void sendRequest() {
        ...
        //下载失败界面选择
        if (radioGroup3.getCheckedRadioButtonId() == R.id.btn31) {
        } else if (radioGroup3.getCheckedRadioButtonId() == R.id.btn32) {
...
//builder.setNewestVersionCode(10);
    ...
    private CustomDownloadFailedListener createCustomDownloadFailedDialog() {
        return (context, versionBundle) -> {
            BaseDialog baseDialog = new BaseDialog(context, R.style.BaseDialog, R.layout.cv_custom_download_failed_dialog);
            return baseDialog;
        };
    }
    ...
    private CustomDownloadingDialogListener createCustomDownloadingDialog() {
        return new CustomDownloadingDialogListener() {
            ...
            public Dialog getCustomDownloadingDialog(Context context, int progress, UIData versionBundle) {
                BaseDialog baseDialog = new BaseDialog(context, R.style.BaseDialog, R.layout.cv_custom_download_layout);
                return baseDialog;
            }
    ...
    private CustomVersionDialogListener createCustomDialogOne() {
        return (context, versionBundle) -> {
            BaseDialog baseDialog = new BaseDialog(context, R.style.BaseDialog, R.layout.cv_custom_dialog_one_layout);
    ...
    private NotificationBuilder createCustomNotification() {
        return NotificationBuilder.create()
                ...
                .setContentTitle("cv_custom title")
